...
export async function FeaturedPostsSection({ section, lang = 'en', translationId, translationRow }: Props) {
  const {
    showExcerpt = true,
    showTags    = true,
  } = section
  ...
  return (
    <section className="w-full px-4 sm:px-6 py-14 max-w-7xl mx-auto">
      ...
      <div className="flex items-end justify-between mb-8 gap-4 flex-wrap">
        <div>
          <h2
            data-directus={pageAttr(translationId, 'featured_posts_heading')}
          ...
          {subheading && (
            <p
              data-directus={pageAttr(translationId, 'featured_posts_subheading')}
