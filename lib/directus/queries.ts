...
/** Fetch the site-wide config (id = 'site-config').
 *  Uses readItem by ID — avoids the alias-field SQL bug that breaks GET /items/site_config
 *  (singleton endpoint) on Directus Cloud. Translations are fetched separately.
 */
